...
###############################################################################
X_train = np.load('data/X_train_notMNIST.npy')
y_train = np.load('data/y_train_notMNIST.npy')
X_test = np.load('data/X_test_notMNIST.npy')    
y_test = np.load('data/y_test_notMNIST.npy')    
